...
Download the required training images from the official @tao2022internal dataset and use the provided annotation files to reproduce the training and testing annotations used in our research. The evaluation images and corresponding binary masks can be downloaded separately from the Google Drive link provided above.
...
If you use these annotation files, evaluation data, or any part of this repository in your research, please cite both the original dataset (@tao2022internal) and our accompanying paper.
